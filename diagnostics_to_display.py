...
with open('battery.txt', 'r') as file:
    # Read the content, convert it back to float
    battery = "Battery: " + file.read().strip() + "%" 
print(battery)
...
#    epd.Clear()
 ...
 #   time.sleep(2)
    ...
    draw.text((2, 0), IPAddr, font = font18, fill = 0)
    draw.text((2, 22), battery, font = font18, fill = 0)
